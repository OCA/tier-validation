...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:f8b5a15cd50cd1d8d469992c3b0ff99ac0d04f069f22f8f3c0fc460649a8c9ac
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
2. Create or edit the ``base_tier_validation.late_after_days``
   parameter.

**Note:**

- The tier-review systray splits your reviews into *Late*, *Pending* and
  *Future* buckets. A pending review is counted as *Late* once it has
  been waiting for more than ``base_tier_validation.late_after_days``
  days (default ``7``). Lower the value to be alerted sooner, raise it
  to be more tolerant. The parameter is read on each systray refresh, so
  a change takes effect immediately without restarting.
